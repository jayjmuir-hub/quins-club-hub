...
-- moved DM review from EVERY admin to the explicit welfare grant (and
-- 20260830_welfare_review_gate narrowed reports the same way), so a plain
-- admin persona can no longer read or act on a reported DM. The negative —
-- a NON-welfare admin being refused — is proven in db/tests/dm-review-welfare.sql.
insert into memberships (profile_id, club_id, team_id, player_id, role, status, admin_rights) values
 ...
 ('f0000000-0000-4000-8000-000000000047','f0000000-0000-4000-8000-0000000000c5', null, null, 'admin','active', array['welfare']);
