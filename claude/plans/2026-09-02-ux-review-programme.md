...
| Low | the two "Smaller items" lists and the extra findings | batches 1-2 building, `claude/ux-low-1`. **Deferred:** DatePicker spoken day labels; share-outcome status; SquadHub squad switcher; PlayerForm save-disabled hint; the extra-findings list |
