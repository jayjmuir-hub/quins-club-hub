...
| Low | the two "Smaller items" lists and the extra findings | batches 1-2 building, `claude/ux-low-1`. **Deferred:** share-outcome status; SquadHub squad switcher; PlayerForm save-disabled hint; the extra-findings list. DatePicker spoken day labels and the AddGameForm / TrainingPublish picker swap: `claude/ux-pickers` |
