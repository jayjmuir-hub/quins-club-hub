...
const PITCH_LINES = tile(
  `<svg xmlns='http://www.w3.org/2000/svg' width='160' height='160' viewBox='0 0 160 160'><g fill='none' stroke='%23808080' stroke-opacity='.16' stroke-width='2'><path d='M0 40h160M0 120h160'/><circle cx='80' cy='80' r='22'/><path d='M20 36v8M60 36v8M100 36v8M140 36v8M20 116v8M60 116v8M100 116v8M140 116v8' stroke-linecap='round'/></g></svg>`,
)

// The harlequin quarters as diagonal hoops — the masthead's motif, quiet.
const HOOPS = tile(
  `<svg xmlns='http://www.w3.org/2000/svg' width='72' height='72' viewBox='0 0 72 72'><g fill-opacity='.09'><path d='M-8 44 44-8h20L-8 64Z' fill='%232a9d55'/><path d='M28 80 80 28v20L48 80Z' fill='%23802030'/></g></svg>`,
)

// Match balls, scattered.
const BALLS = tile(
  `<svg xmlns='http://www.w3.org/2000/svg' width='140' height='140' viewBox='0 0 140 140'><g fill='none' stroke='%23808080' stroke-opacity='.16' stroke-width='2'><ellipse cx='34' cy='30' rx='16' ry='9' transform='rotate(-22 34 30)'/><path d='M27 33l14-6' stroke-linecap='round'/><ellipse cx='104' cy='96' rx='16' ry='9' transform='rotate(18 104 96)'/><path d='M97 98l14 -4' stroke-linecap='round'/><ellipse cx='110' cy='26' rx='11' ry='6' transform='rotate(-40 110 26)'/></g></svg>`,
)

// The masthead's diagonal shapes, large and sparse.
const HARLEQUIN = tile(
  `<svg xmlns='http://www.w3.org/2000/svg' width='220' height='220' viewBox='0 0 220 220'><g fill-opacity='.07'><path d='M140 0h44L64 120H20Z' fill='%232a9d55'/><path d='M220 76v44L96 220H52Z' fill='%23802030'/></g></svg>`,
)

// A drawn shield with quarters — crest-shaped, not the crest itself.
const SHIELD = tile(
  `<svg xmlns='http://www.w3.org/2000/svg' width='200' height='220' viewBox='0 0 200 220'><g stroke='%23808080' stroke-opacity='.13' stroke-width='2.5' fill='none'><path d='M100 30l52 14v52c0 34-20 58-52 74-32-16-52-40-52-74V44Z'/><path d='M100 30v140M48 96h104'/></g></svg>`,
)
